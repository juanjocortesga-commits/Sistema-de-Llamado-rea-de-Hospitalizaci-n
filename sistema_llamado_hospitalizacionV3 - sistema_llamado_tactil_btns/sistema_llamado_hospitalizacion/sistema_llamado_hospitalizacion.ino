...
void setup()
{
    ...
    lv_obj_add_event_cb(objects.btn_call_301, [](lv_event_t *e){ agregarLlamado(301); }, LV_EVENT_CLICKED, NULL);
    lv_obj_add_event_cb(objects.btn_call_302, [](lv_event_t *e){ agregarLlamado(302); }, LV_EVENT_CLICKED, NULL);
    lv_obj_add_event_cb(objects.btn_call_303, [](lv_event_t *e){ agregarLlamado(303); }, LV_EVENT_CLICKED, NULL);
    lv_obj_add_event_cb(objects.btn_call_304, [](lv_event_t *e){ agregarLlamado(304); }, LV_EVENT_CLICKED, NULL);
